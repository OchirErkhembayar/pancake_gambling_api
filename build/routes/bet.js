...
router.post('/new-private-bet', is_auth_1.authUser, bet_1.default.createPrivateBet);
router.post('/create-bet/:userId/:matchAthleteId', is_auth_1.authUser, bet_1.default.createBet);
router.patch('/accept-private-bet', is_auth_1.authUser, bet_1.default.acceptPrivateBet);
router.delete('/decline-private-bet', is_auth_1.authUser, bet_1.default.declinePrivateBet);
